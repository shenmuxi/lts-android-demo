...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input", required=True, help="输入的配置文件路径")
    parser.add_argument("-o", "--output", required=True, help="输出的加密文件路径")
    ...
    try:
        ...
        if encrypted_data:
            ...
            print(f"请重新构建并运行Demo，并在“加载预配置”时输入相同密码。")
    except Exception as e:
        print(f"运行出错: {e}")
